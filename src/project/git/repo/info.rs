...
use super::push;
use super::remote;
use super::remote::GitOrigin;
use super::remote::RemoteInfo;
use super::remote::RemoteResolveContext;
use super::remote::UpstreamRemote;
use super::workflow;
use super::workflow::WorkflowPresence;
use crate::config;
...
impl RepoInfo {
    ...
    pub fn get(probe_path: &Path) -> Option<Self> {
        ...
        let remote_names = remote::list_remote_names(&repo_root);
